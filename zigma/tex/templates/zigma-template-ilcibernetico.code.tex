...
\cs_new_protected:Npn \zigma_template_postsetup:
  {
    ...
    % Drop cap helper for ilcibernetico body text.
    % Usage:
    %   \zigmailcincipit{L}{a cibernetica ...}
    % Optional:
    %   \zigmailcincipit[lines=2]{L}{a cibernetica ...}
    \ProvideDocumentCommand \zigmailcincipit { O{lines=3} m m }
      {
