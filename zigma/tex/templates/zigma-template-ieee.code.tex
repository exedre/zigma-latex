...
%%   Example: ztemplate=ieee-conference,zmarginleft=1in → uses 1in
%%
...
\else
  ...
  \else
    ...
    \typeout{[TEMPLATE WARNING] ieee-conference expects article, but zbaseclass=\zigma@baseclass\space specified}
