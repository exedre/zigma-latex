    ...
    \tl_if_empty:NF \g_zigma_meta_keywords_tl
      {
        ...
        \vspace{0.5em}
        \noindent
        \textbf{Keywords:}~\tl_use:N \g_zigma_meta_keywords_tl
        \par
        \vspace{1em}
      }
  }
...
\cs_new_protected:Npn \zigma_article_render_metadata_footer:
  {
    ...
    \tl_if_empty:NF \g_zigma_meta_published_rendered_tl { \int_incr:N \l_tmpa_int }
    \tl_if_empty:NF \g_zigma_meta_license_rendered_tl { \int_incr:N \l_tmpa_int }
    ...
    \int_compare:nNnT { \l_tmpa_int } > { 0 }
      {
        ...
        % Published line on separate line
        \tl_if_empty:NF \g_zigma_meta_published_rendered_tl
          {
            \noindent
            {\small\g_zigma_meta_published_rendered_tl}
            \par
          }
        ...
        \tl_if_empty:NF \g_zigma_meta_license_rendered_tl
          {
            \vspace{0.3em}
            \noindent
            {\small\g_zigma_meta_license_rendered_tl}
            \par
          }
