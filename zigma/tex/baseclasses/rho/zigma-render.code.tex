...
% Override with: \documentclass[zmarginleft=3cm,zmargintop=2.5cm,...]{zigma}
...
% Can be overridden via color.main in zigmasetup
...
\cs_new:Npn \zigma_rho_title_font: {
  \tl_if_empty:NF \g_zigma_color_title_tl
    { \color{\g_zigma_color_title_tl} }
    {
      \tl_if_empty:NF \g_zigma_color_main_tl
        { \color{\g_zigma_color_main_tl} }
        { \color{rhocolor} }
    }
  \sffamily\bfseries\fontsize{16}{22}\selectfont
}
\cs_new:Npn \zigma_rho_title_url_marker_font:
  {
    % Keep title style but render title.url.show marker slightly smaller.
    \fontsize{13}{18}\selectfont
  }
\cs_new:Npn \zigma_rho_author_font: {
  \tl_if_empty:NTF \g_zigma_color_author_tl
    { \color{black} }
    { \color{\g_zigma_color_author_tl} }
  \fontsize{9}{11}\bfseries\sffamily\selectfont
}
\cs_new:Npn \zigma_rho_affil_font: { \fontsize{7.5}{9}\itshape\selectfont }
\cs_new:Npn \zigma_rho_abstract_head_font: { 
  \tl_if_empty:NF \g_zigma_color_main_tl 
    { \color{\g_zigma_color_main_tl} }
    { \color{rhocolor} }
  \sffamily\fontsize{9}{11}\selectfont\bfseries 
}
\cs_new:Npn \zigma_rho_abstract_font: {
  \tl_if_empty:NF \g_zigma_color_text_tl
    { \color{\g_zigma_color_text_tl} }
    { \color{black} }
  \sffamily\linespread{1}\fontsize{8.5}{11}\selectfont
}
\cs_new:Npn \zigma_rho_keywords_font: {
  \color{\zigma_rho_keywords_color_name:}
  \sffamily\itshape\linespread{1}\fontsize{7.8}{9}\selectfont
}
\cs_new:Npn \zigma_rho_info_font: {
  \tl_if_empty:NF \g_zigma_color_text_tl
    { \color{\g_zigma_color_text_tl} }
    { \color{black} }
  \sffamily\linespread{1}\fontsize{7.8}{9}\selectfont
}
\cs_new:Npn \zigma_rho_footer_font: { \normalfont\sffamily\fontsize{7}{9}\selectfont }

\cs_new:Npn \zigma_rho_text_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_text_tl
      { black }
      { \tl_use:N \g_zigma_color_text_tl }
  }
\cs_new:Npn \zigma_rho_keywords_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_keywords_tl
      { \zigma_rho_text_color_name: }
      { \tl_use:N \g_zigma_color_keywords_tl }
  }
\cs_new:Npn \zigma_rho_header_left_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_header_left_tl
      { \zigma_rho_text_color_name: }
      { \tl_use:N \g_zigma_color_header_left_tl }
  }
\cs_new:Npn \zigma_rho_header_center_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_header_center_tl
      { \zigma_rho_text_color_name: }
      { \tl_use:N \g_zigma_color_header_center_tl }
  }
\cs_new:Npn \zigma_rho_header_right_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_header_right_tl
      { \zigma_rho_text_color_name: }
      { \tl_use:N \g_zigma_color_header_right_tl }
  }
\cs_new:Npn \zigma_rho_footer_left_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_footer_left_tl
      { \zigma_rho_text_color_name: }
      { \tl_use:N \g_zigma_color_footer_left_tl }
  }
\cs_new:Npn \zigma_rho_footer_center_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_footer_center_tl
      { \zigma_rho_text_color_name: }
      { \tl_use:N \g_zigma_color_footer_center_tl }
  }
\cs_new:Npn \zigma_rho_footer_right_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_footer_right_tl
      { \zigma_rho_text_color_name: }
      { \tl_use:N \g_zigma_color_footer_right_tl }
  }

\cs_new:Npn \zigma_rho_section_color_name:
  {
    \tl_if_empty:NTF \g_zigma_color_section_tl
      { black }
      { \tl_use:N \g_zigma_color_section_tl }
  }

% Apply color.section to section heading commands
\cs_new_protected:Npn \zigma_rho_apply_section_colors:
  {
    \makeatletter
    \renewcommand\section{\@startsection {section}{1}{\z@}%
      {-3.5ex \@plus -1ex \@minus -.2ex}%
      {2.3ex \@plus .2ex}%
      {\normalfont\Large\bfseries\color{\zigma_rho_section_color_name:}}}
    ...
    \renewcommand\subsubsection{\@startsection{subsubsection}{3}{\z@}%
      {-3.25ex\@plus -1ex \@minus -.2ex}%
      {1.5ex \@plus .2ex}%
      {\normalfont\normalsize\bfseries\color{\zigma_rho_section_color_name:}}}
...
\AtBeginDocument{ \zigma_rho_apply_section_colors: }
...
\fancypagestyle{firststyle}{
  \fancyfoot[L]{
    ...
    \color{\zigma_rho_footer_left_color_name:}
    \tl_use:N \g_zigma_footer_left_tl
  }
  \fancyfoot[C]{
    \zigma_rho_footer_font:
    \color{\zigma_rho_footer_center_color_name:}
    \tl_use:N \g_zigma_footer_center_tl
  }
  \fancyfoot[R]{
    \zigma_rho_footer_font:
    \color{\zigma_rho_footer_right_color_name:}
...
\fancyhead[L]{
  \zigma_rho_footer_font:
  \color{\zigma_rho_header_left_color_name:}
...
\fancyhead[C]{
  \zigma_rho_footer_font:
  \color{\zigma_rho_header_center_color_name:}
  \tl_use:N \g_zigma_header_center_tl
}
\fancyhead[R]{
  \zigma_rho_footer_font:
  \color{\zigma_rho_header_right_color_name:}
...
\cs_new_protected:Npn \zigma_rho_render_title:
  {
    ...
    \tl_if_empty:NF \g_zigma_journal_name_tl
      {
        \group_begin:
        \sffamily\bfseries\fontsize{8}{14}\selectfont
        % Apply color.journal
        \tl_if_empty:NF \g_zigma_color_journal_tl
          { \color{\g_zigma_color_journal_tl} }
        % Journal name and URL link
        \tl_if_empty:NTF \g_zigma_journal_url_tl
          {
            % No URL: just render the name
            \tl_use:N \g_zigma_journal_name_tl
          }
          {
            % Has URL: check if we should make journal name clickable
            \str_if_eq:VnTF \g_zigma_journal_url_show_tl { true }
              {
                % Make journal name clickable
                \exp_args:NV \href \g_zigma_journal_url_tl { \tl_use:N \g_zigma_journal_name_tl }
              }
              {
                % Journal name not clickable; check if we should add a symbol link
                \tl_use:N \g_zigma_journal_name_tl
                \tl_if_empty:NF \g_zigma_journal_url_show_tl
                  {
                    \nobreakspace
                    \exp_args:NV \href \g_zigma_journal_url_tl { \tl_use:N \g_zigma_journal_url_show_tl }
                  }
              }
          }
        \par
    ...
    \tl_if_empty:NF \g_zigma_title_tl
      {
        ...
        % Title text and URL link
        \tl_if_empty:NTF \g_zigma_title_url_tl
          {
            % No URL: just render the title
            \tl_use:N \g_zigma_title_tl
          }
          {
            % Has URL: check if we should make title clickable
            \str_if_eq:VnTF \g_zigma_title_url_show_tl { true }
              {
                % Make title clickable
                \exp_args:NV \href \g_zigma_title_url_tl { \tl_use:N \g_zigma_title_tl }
              }
              {
                % Title not clickable; check if we should add a symbol link
                \tl_use:N \g_zigma_title_tl
                \tl_if_empty:NF \g_zigma_title_url_show_tl
                  {
                    \nobreakspace
                    \exp_args:NV \href \g_zigma_title_url_tl
                      {
                        {\zigma_rho_title_url_marker_font: \tl_use:N \g_zigma_title_url_show_tl}
                      }
                  }
              }
          }
    ...
    \tl_if_empty:NF \g_zigma_subtitle_tl
      {
        \vskip5pt
        {
          ...
          \tl_if_empty:NTF \g_zigma_color_subtitle_tl
            { \color{rhocolor} }
            { \color{\g_zigma_color_subtitle_tl} }
          \tl_use:N \g_zigma_subtitle_tl\par
        }
      }
...
\cs_new_protected:Npn \zigma_rho_render_abstract:
  {
    ...
    \tl_if_empty:NF \g_zigma_abstract_tl
      {
        \begin{tcolorbox}[
          colback=\tl_use:N \g_zigma_color_box_bg_tl, 
          colframe=\tl_use:N \g_zigma_color_box_line_tl,
          arc=0pt, 
          boxrule=0pt, 
          left=5pt, 
          right=5pt, 
          ...
          % Keywords if set
          \tl_if_empty:NF \g_zigma_meta_keywords_tl
            {
              \vskip10pt
              {\zigma_rho_keywords_font: \textbf{Keywords:}~\tl_use:N \g_zigma_meta_keywords_tl}
            }
        \end{tcolorbox}
        \vspace{10pt}
      }
    ...
    \bool_if:NT \g_zigma_corresponding_footer_bool
      {
        ...
        \tl_if_empty:NF \g_zigma_meta_accepted_tl { \int_incr:N \l__zigma_rho_meta_count_int }
            \tl_if_empty:NF \g_zigma_meta_published_rendered_tl { \int_incr:N \l__zigma_rho_meta_count_int }
            \tl_if_empty:NF \g_zigma_meta_license_rendered_tl { \int_incr:N \l__zigma_rho_meta_count_int }
        ...
        \int_compare:nNnT { \l__zigma_rho_meta_count_int } > { 0 }
          {
            ...
            \tl_if_empty:NF \g_zigma_meta_published_rendered_tl
              {
                \tl_if_empty:NF \g_zigma_meta_received_tl { \par }
                \g_zigma_meta_published_rendered_tl\par
              }
            
            % License
            \tl_if_empty:NF \g_zigma_meta_license_rendered_tl
              {
                \vskip3pt
                \g_zigma_meta_license_rendered_tl\par
              }
            }
            \vskip1pt
