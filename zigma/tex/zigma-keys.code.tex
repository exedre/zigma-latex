...
\keys_define:nn { zigma / setup } {
  ...
  color.text      .tl_set:N = \g_zigma_color_text_tl,
  color.url       .tl_set:N = \g_zigma_color_url_tl,
  color.journal   .tl_set:N = \g_zigma_color_journal_tl,
  color.title     .tl_set:N = \g_zigma_color_title_tl,
  color.subtitle  .tl_set:N = \g_zigma_color_subtitle_tl,
  color.author    .tl_set:N = \g_zigma_color_author_tl,
  color.keywords      .tl_set:N = \g_zigma_color_keywords_tl,
  color.header.left   .tl_set:N = \g_zigma_color_header_left_tl,
  color.header.center .tl_set:N = \g_zigma_color_header_center_tl,
  color.header.right  .tl_set:N = \g_zigma_color_header_right_tl,
  color.footer.left   .tl_set:N = \g_zigma_color_footer_left_tl,
  color.footer.center .tl_set:N = \g_zigma_color_footer_center_tl,
  color.footer.right  .tl_set:N = \g_zigma_color_footer_right_tl,
  ...
  % Link styling
  links.style         .tl_set:N = \g_zigma_links_style_tl,
  links.url.color     .tl_set:N = \g_zigma_links_url_color_tl,
  links.url.underline .bool_set:N = \g_zigma_links_url_underline_bool,
  links.url.underline .initial:n  = false,
  ...
  metadata.published.show .bool_set:N = \g_zigma_meta_published_show_bool,
  metadata.published.show .initial:n  = false,
  metadata.published.date .tl_set:N = \g_zigma_meta_published_date_tl,
  metadata.published.venue .tl_set:N = \g_zigma_meta_published_venue_tl,
  metadata.published.title .tl_set:N = \g_zigma_meta_published_title_tl,
  metadata.published.url  .tl_set:N = \g_zigma_meta_published_url_tl,
  metadata.published.label .tl_set:N = \g_zigma_meta_published_label_tl,
  ...
  metadata.license.type  .tl_set:N = \g_zigma_meta_license_type_tl,
  metadata.license.id    .tl_set:N = \g_zigma_meta_license_id_tl,
  metadata.license.holder .tl_set:N = \g_zigma_meta_license_holder_tl,
  metadata.license.year  .tl_set:N = \g_zigma_meta_license_year_tl,
  metadata.license.url   .tl_set:N = \g_zigma_meta_license_url_tl,
  metadata.license.note  .tl_set:N = \g_zigma_meta_license_note_tl,
  ...
  layout.vertical.fill .tl_set:N = \g_zigma_layout_vertical_fill_tl,
...
\cs_new_protected:Npn \zigma_copy_prop_to_state: {
  ...
  % Links
  \zigma_apply_if_present:nn {links.style}
    { \tl_gset:NV \g_zigma_links_style_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {links.url.color}
    { \tl_gset:NV \g_zigma_links_url_color_tl \l_tmpa_tl }
  ...
  \zigma_apply_if_present:nn {metadata.published.show}
    { \bool_gset:Nn \g_zigma_meta_published_show_bool { \l_tmpa_tl } }
  \zigma_apply_if_present:nn {metadata.published.date}
    { \tl_gset:NV \g_zigma_meta_published_date_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.published.venue}
    { \tl_gset:NV \g_zigma_meta_published_venue_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.published.title}
    { \tl_gset:NV \g_zigma_meta_published_title_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.published.url}
    { \tl_gset:NV \g_zigma_meta_published_url_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.published.label}
    { \tl_gset:NV \g_zigma_meta_published_label_tl \l_tmpa_tl }
  ...
  \zigma_apply_if_present:nn {metadata.license.type}
    { \tl_gset:NV \g_zigma_meta_license_type_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.license.id}
    { \tl_gset:NV \g_zigma_meta_license_id_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.license.holder}
    { \tl_gset:NV \g_zigma_meta_license_holder_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.license.year}
    { \tl_gset:NV \g_zigma_meta_license_year_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.license.url}
    { \tl_gset:NV \g_zigma_meta_license_url_tl \l_tmpa_tl }
  \zigma_apply_if_present:nn {metadata.license.note}
    { \tl_gset:NV \g_zigma_meta_license_note_tl \l_tmpa_tl }
  ...
  \zigma_apply_if_present:nn {layout.vertical.fill}
    { \tl_gset:NV \g_zigma_layout_vertical_fill_tl \l_tmpa_tl }
...
\cs_new_protected:Npn \zigma_apply_setup:
  {
    ...
    % Step 3.5: Promote color.url to link color when links.url.color is untouched.
    % This keeps links.url.color as the explicit override while making color.url effective.
    \tl_if_empty:NF \g_zigma_color_url_tl
      {
        \tl_if_eq:NnT \g_zigma_links_url_color_tl { zigma-accent }
          { \tl_gset:Nx \g_zigma_links_url_color_tl { \tl_use:N \g_zigma_color_url_tl } }
      }

    % Step 4: Apply hyperlink visual policy (no URL boxes + style from setup)
    \zigma_apply_link_style:

    % Step 5: Apply vertical fill policy (\flushbottom or \raggedbottom)
    \zigma_apply_vertical_fill_policy:

    % Step 6: Apply dropcap policy (neutralize \lettrine when disabled)
    \zigma_apply_dropcap_policy:

    % Step 7: Build canonical license text (used by all renderers)
    \zigma_meta_license_render_build:

    % Step 8: Build canonical publication string
    \zigma_meta_published_render_build:

    % Step 9: Display configuration state (debug mode only)
    \bool_if:NT \g_zigma_debug_bool { \zigma_log_state_soft: }
    
    % Step 10: Display registered authors (debug mode only)
...
\keys_define:nn { zigma/setup }
  {
    doi .tl_gset:N = \g_zigma_meta_doi_tl,
    received .tl_gset:N = \g_zigma_meta_received_tl,
    revised .tl_gset:N = \g_zigma_meta_revised_tl,
    accepted .tl_gset:N = \g_zigma_meta_accepted_tl,
    published .tl_gset:N = \g_zigma_meta_published_tl,
    license .tl_gset:N = \g_zigma_meta_license_tl,
